define(['sorttable', 'virtual-dom', 'd3-interpolate', 'moment', 'helper'],
  function (SortTable, V, d3Interpolate, moment, helper) {
    ...
    function showClients(d) {
      ...
      return function (el) {
        if (typeof d.statistics.clients === 'object') {
          var text = 'keine';
    ...
    function showRAM(d) {
      if (!('memory_usage' in d.statistics || 'memory' in d.statistics)) {
        return undefined;
      }

      return function (el) {
        var width = typeof d.statistics.memory === 'object' ? (1 - (d.statistics.memory.free + d.statistics.memory.buffers + d.statistics.memory.cached) / d.statistics.memory.total) : d.statistics.memory_usage;
    ...
    return function (config, el, router, d) {
      ...
      function renderNeighbourRow(n) {
        ...
        var td2 = V.h('td', name);
        var td3 = V.h('td', (n.node.statistics.clients) ? (typeof n.node.statistics.clients === 'object' ? n.node.statistics.clients.total : n.node.statistics.clients).toString() : '0');
      ...
      if (d.neighbours.length > 0) {
        ...
        var headings = [{
          ...
          class: 'ion-people',
          sort: function (a, b) {
            if (typeof a.node.statistics.clients === 'object') {
