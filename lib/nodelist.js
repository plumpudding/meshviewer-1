define(['sorttable', 'virtual-dom', 'helper'], function (SortTable, V, helper) {
  ...
  var headings = [{
    ...
    class: 'ion-people',
    sort: function (a, b) {
      if (typeof a.statistics.clients === 'object') {
  ...
  return function (router) {
    function renderRow(d) {
      ...
      var td4 = V.h('td', Number('clients' in d.statistics ? (typeof d.statistics.clients === 'object' ? d.statistics.clients.total : d.statistics.clients) : 0).toFixed(0));
