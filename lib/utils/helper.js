...
define({
  ...
  positionClients: function positionClients(ctx, p, startAngle, clients, startDistance) {
    var lanclient = (typeof clients === 'object' ? clients.total - clients.wifi : 0);
    var wifi5 = (typeof clients === 'object' ? clients.wifi5 : 0);
    clients = (typeof clients === 'object' ? clients.total : clients);
    if (clients === 0) {
      return;
    }
